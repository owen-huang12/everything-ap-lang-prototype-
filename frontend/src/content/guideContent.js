  ...
  synthesis: [
    {
      ...
      text: "The synthesis essay (Q1) gives you 6–7 sources on a single topic and asks you to argue your own position using at least three of them. The main goal of the synthesis essay is to put these **sources in conversation with each other**.\n\nYou are not exploring the rhetorical techniques the author uses (**rhetorical analysis essay**), nor making an argument from scratch (**argumentative essay**). You are building your argument from the pieces of evidence that you are given."    },
    {
  ...
  rhetorical: [
    {
      ...
      text: "The core of the ** rhetorical analysis essay ** is not what the author is “saying,” but rather what the author is “doing.” Every AP Lang Q2 prompt asks the same thing: **analyze the rhetorical choices the speaker makes to achieve their purpose**.\n\nTry to move from **summarizing**:\n\n“Malala says education is important”\n\nTo providing **rhetorical analysis** (what Malala doing and why is it important):\n\n“By opening with her own near-death experience, Malala transforms an abstract policy debate into a personal imperative.”\n\nDo you see the distinction?",
    },
    {
      heading: "SPACECAT(M)",
    ...
    },
    {
      ...
      text: "**6 common essay mistakes:**\n\n1. Name the device but don't explain it\n\n2. Paraphrase the quote instead of analyzing it\n\n3. Go through the motions without real analysis\n\n4. Drop the rhetorical situation in body paragraphs\n\n5. Misidentify the audience or context\n\n6. Lose focus in the conclusion",
    },
    {
      heading: "thesis levels",
      text: "You want to move on from level 1 thesis to level 3: \n\n**Level 1 — Row A:** Names devices + purpose. 'In her 2013 UN speech, Malala Yousafzai uses personal narrative, anaphora, and antithesis to convince UN delegates to act on girls' education.'\n\n**Level 2 — Row B 3–4:** Adds context and the obstacle. 'Speaking at the UN nine months after being shot for attending school, Malala Yousafzai uses personal narrative, anaphora, and antithesis to convince delegates that girls' education is a moral imperative, not a policy preference. To do this, she must overcome delegates' tendency to treat education as one issue among many.'\n\n**Level 3 — Row C:** Also names her leverage as a survivor resisting the victim narrative. Only attempt if you can sustain it every paragraph.",
    },
    {
      heading: "the commentary loop",
      text: "Many students lose evidence and commentary points because their commentary stops at identification. They summarize the text, instead of providing rhetorical analysis. The **close the loop**. Instead use a **commentary loop**. \n\n**The Commentary Loop:** this choice DOES [X] for this AUDIENCE because of [Y obstacle].",
    },
    {
      heading: "score yourself",
